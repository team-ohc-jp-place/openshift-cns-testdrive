...
* Access Key ID: この情報は、本ワークショップ用のガイダンスページの *AWS_ACCESS_KEY_ID* というフィールドにあります。

* Secret Access Key ID: この情報は、本ワークショップ用のガイダンスページの *AWS_SECRET_ACCESS_KEY* というフィールドにあります。
...
* *Release Image* を選択します。 今回は4.16を使用するので「4.16.XX」を選択してください。
