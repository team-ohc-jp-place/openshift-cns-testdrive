...
image::images/ocp4-Lab1-3_overview.png[]
...
+
image::images/ocp4-lab1-3-developer-console.png[]

. [</> Developer] > [+Add] > [Project: プルダウンメニューを選択] > [Create Project] を選択します。
+
image::images/ocp4-lab1-3-create-project.png[]

. プロジェクト名(例: `blog` )を指定し、*Create* を選択します。
+
image::images/ocp4-lab1-3-create-project-blog.png[]
+
[TIPS]
====
...
+
image::images/ocp4-lab1-3-from-catalog.png[]

. 次に [Python] テンプレート を選択します。
+
image::images/ocp4-lab1-3-from-catalog-python.png[]
+
[TIPS]
====
...
最初に、*[Create Application]*　を選択します。 +
 image:images/ocp4-lab1-3-from-catalog-python-create.png[]
+
...
+
image::images/ocp4-lab1-3-from-catalog-python-create-detail.png[]
+
...
image::images/ocp4-lab1-3-topology.png[]
====
...
+
image::images/ocp4-lab1-3-topology-pod.png[]
+
コンテナが作成され、起動していると以下のように表示されます。
+
image::images/ocp4-lab1-3-topology-pod-detail.png[]
+
[TIPS]
====
...
image::images/ocp4-lab1-3-topology-pod-terminal.png[]
====
...
+
image::images/ocp4-lab1-3-create-route-admin-console.png[]

. [Administrator] > [Networking] > [Routes] > [Create Route] を選択します。
+
image::images/ocp4-lab1-3-create-route.png[]
...
+
image::images/ocp4-lab1-3-create-route-detail.png[]
+
...
image::images/ocp4-lab1-3-create-route-blog.png[]

image::images/ocp4-lab1-3-create-route-result.png[]
====
...
+
image::images/ocp4-lab1-3-create-route-confirm.png[]

. blogアプリのサンプルページに自身のPod名が表示されていることを確認します。
+
image::images/ocp4-lab1-3-create-route-confirm-result.png[]
+
Pod名が分からない場合は、[Workloads] > [Pods] のPod一覧から確認しましょう。
+
image::images/ocp4-lab1-3-create-route-confirm-result-pod.png[]
