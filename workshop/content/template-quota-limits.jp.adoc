...
link:https://docs.openshift.com/container-platform/4.6/openshift_images/using-templates.html[template documentation^].
We will not go into more detail on *Templates* in these
exercises.
====
>>>>>>> upstream/ocp4-dev
...
The
link:https://docs.openshift.com/container-platform/4.6/applications/quotas/quotas-setting-per-project.html[quota documentation^]
...
link:https://docs.openshift.com/container-platform/4.6/applications/quotas/quotas-setting-per-project.html[quota
documentation^]

### Background: LimitRange
The
link:https://docs.openshift.com/container-platform/4.6/nodes/clusters/nodes-cluster-limit-ranges.html[limit
...
link:https://docs.openshift.com/container-platform/4.6/applications/quotas/quotas-setting-across-multiple-projects.html[multi-project
