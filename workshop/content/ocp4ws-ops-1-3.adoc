...
----
$ oc new-project userX-jmx
Now using project "userX-jmx" on server "https://api.cluster-3adc.3adc.sandbox691.opentlc.com:6443".
...
$ oc project
Using project "userX-jmx" on server "https://api.cluster-8a39.8a39.sandbox135.opentlc.com:6443".
----
+
