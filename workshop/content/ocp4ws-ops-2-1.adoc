...
+
image::images/ocp4-i-lab1-1-imagestream-jboss.png[]
...
image::images/jboss-eap-prometheus-8080.jpg[Jboss Application]
...
image::images/jboss-eap-prometheus-9404.jpg[Jboss Application]
